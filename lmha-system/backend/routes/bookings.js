...
router.patch('/:id', async (req, res, next) => {
  try {
    ...
    if (hasOwn(req.body, 'time_in')) values.time_in = req.body.time_in ? parseTimeString(req.body.time_in, 'time_in') : null;
    if (hasOwn(req.body, 'time_out')) values.time_out = req.body.time_out ? parseTimeString(req.body.time_out, 'time_out') : null;
